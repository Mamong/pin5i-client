...
- (void)initial
{
    ...
    [self addSubview:_arrowImage = arrowImage];
      ...
      // 5.动态图片
    NSString *filePath = [[NSBundle mainBundle]pathForResource:@"woodpecker.gif" ofType:nil];
    SCGIFImageView *scImage = [[SCGIFImageView alloc]initWithGIFFile:filePath];
    [self addSubview:_scGIFImage = scImage];
...
- (void)setFrame:(CGRect)frame
{
    ...
    // 4.动态图片
    _scGIFImage.bounds = CGRectMake(0, 0, _scGIFImage.image.size.width, _scGIFImage.image.size.height);
    _scGIFImage.center = _arrowImage.center;
